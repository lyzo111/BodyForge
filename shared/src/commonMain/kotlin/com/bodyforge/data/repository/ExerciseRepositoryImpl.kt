...
class ExerciseRepositoryImpl : ExerciseRepository {
    ...
    override suspend fun ensureStockExercises() = withContext(Dispatchers.IO) {
        ...
        add("running", "Running", listOf("Cardio"), "None", true, 60)
        add("cycling", "Cycling", listOf("Cardio"), "Bike", true, 60)
        add("cross_stepper", "Cross-Stepper", listOf("Cardio"), "Cross Trainer", true, 60)
        add("rowing", "Rowing", listOf("Cardio"), "Rowing Machine", true, 60)
